...
export default function Regulamin() {
  return <div className="regulamin">
    ...
    <div className="regulamin-container">
      ...
      <p>Nie testuj nowości kosmetycznych</p>
      <p>Na wizytę przychodzimy bez makijażu, w swojej codziennej pielęgnacji</p>
      <p>Powiadom mnie przed wizytą o swoich alergiach</p>
      ...
      <p>Załóż na naszą wizytę bluzkę z podobnym dekoltem, który ma twoja docelowa kreacja</p>
      <p>Zrezygnuj z zabiegów mocno złuszczających</p>
      <p className="float">~Niech twój dzień będzie równie nieskazitelny, jak twój makijaż~</p>
    </div>
  </div>
}